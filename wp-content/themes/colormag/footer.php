...
<footer id="colophon" class="clearfix <?php echo esc_attr( $class_name ); ?>" style=" background-color:white; !important">
	...
	<div class="footer-socket-wrapper clearfix">
		<div class="inner-wrap">
			<div class="footer-socket-area">
				...
				<div class="footer-socket-left-section" style="color:#fff; !important">
